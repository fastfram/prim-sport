...
! function (t) {
    ...
    i.resize = A(u, _), i.scroll = A(u, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"), i.redraw = A(), i.location = function (t) {
        window.location = t
        ...
        var R = e.frame = function () {
            ...
            N = l(function (e) {
                ...
                e.init = function (e) {
                    ...
                    I.backface && B.hideBackface && Z(this.el, I.backface.css, "hidden")
            ...
            H = l(function (e) {
                function n() {
                    ...
                    if (r)
                        for (R(n), e = j(), t = r; t--;)(i = u[t]) && i.render(e)
                }
                var i = {
                    ease: f.ease[1],
                    from: 0,
                ...
                e.init = function (t) {
                    ...
                    var t;
                    this.active || (this.start || (this.start = j()), this.active = !0, t = this, 1 === u.push(t) && R(n))
                }, e.stop = function () {
                    var e, n, i;
    ...
    n(5), n(8), n(9), n(10), n(11), n(13), n(18), t.exports = n(19)
}, function (t, e, n) {
    "use strict";
    var i = n(0);
    ...
    i.define("dropdown", t.exports = function (t, e) {
        ...
        function b() {
            s = l && i.env("design"), (n = c.find(h)).each(y)
        }
        ...
        function y(n, r) {
            ...
            f || (f = t.data(r, h, {
                ...
                n.outside && c.off(d + h, n.outside);
                return e.debounce(function (e) {
                    if (n.open) {
                        var r = t(e.target);
                        if (!r.closest(".w-dropdown-toggle").length) {
                            var o = -1 === t.inArray(n.el[0], r.parents(h)),
                                a = i.env("editor");
                            if (o) {
                                if (a) {
                ...
                return function () {
                    t.hovering = !1, t.links.is(":focus") || E(t)
                }
            }(f), f.moveOutside = function (n) {
                return e.debounce(function (e) {
                    if (n.open) {
                        var i = t(e.target),
                            r = -1 === t.inArray(n.el[0], i.parents(h));
                        if (r) {
            ...
            }(f), u.off(h), f.toggle.off(h), x(f), f.nav && f.nav.off(h), f.nav = u.closest(".w-nav"), f.nav.on(v, k(f)), s ? u.on("setting" + h, k(f)) : (f.toggle.on(d + h, _(f, a)), f.config.hover && f.toggle.on("mouseenter" + h, function (t) {
                return function () {
                    t.hovering = !0, A(t), t.links.is(":focus") || t.toggle.focus()
                }
            }(f)), u.on(v, k(f)), l && (f.hovering = !1, E(f)));
            var m = f.list.attr("id"),
                g = f.toggle.attr("id");
            u.attr("role", "menu"), u.on("keydown", T), m || (m = "w-dropdown-list-" + n, f.list.attr("id", m)), u.on("keyup", function (t) {
                return function (e) {
                    if (!s && !w && (t.open || t.toggle.is(":focus"))) switch (e.keyCode) {
                        case o.HOME:
                            if (!t.open) return;
                            return t.selectedIdx = 0, void O(t);
                        case o.END:
                            if (!t.open) return;
                            return t.selectedIdx = t.links.length - 1, void O(t);
                        case o.ESCAPE:
                            return void E(t, {
                                forceClose: !0
                            });
                        case o.ARROW_DOWN:
                            return t.selectedIdx = Math.min(t.links.length - 1, t.selectedIdx + 1), void(t.selectedIdx >= 0 && (t.open || (t.selectedIdx = 0), A(t), O(t)));
                        case o.ARROW_UP:
                            return t.selectedIdx = Math.max(-1, t.selectedIdx - 1), void(t.selectedIdx < 0 ? (E(t, {
                                immediate: !0,
                                forceClose: !0
                            }), t.toggle.focus()) : (A(t), O(t)));
                        default:
                            return
                    }
                }
            }(f)), f.links.attr("tabindex", "-1"), f.links.attr("role", "menuitem"), f.toggle.attr("tabindex") || f.toggle.attr("tabindex", "0"), g || (g = "w-dropdown-toggle-" + n, f.toggle.attr("id", g)), f.toggle.attr("aria-controls", m), f.toggle.attr("aria-haspopup", "menu"), f.toggle.on("keyup", function (t) {
                var e = _(t, a);
                return function (t) {
                    s || w || t.keyCode !== o.SPACE && t.keyCode !== o.ENTER || (t.stopPropagation(), e())
                }
            }(f)), u.attr("aria-labelledby", g), f.toggle.css("outline", "none"), f.links.css("outline", "none")
        }
        ...
        function k(t) {
            return function (e, n) {
                return n = n || {}, "w-close" === e.type ? E(t, {
                    focusToggle: !1
                }) : "setting" === e.type ? (x(t), !0 === n.open && A(t), void(!1 === n.open && E(t, {
                    immediate: !0
                }))) : void 0
            }
        }
        ...
        function A(e) {
            if (!e.open) {
                ! function (e) {
                    ...
                    n.each(function (e, n) {
                        var r = t(n);
                        r.is(i) || r.has(i).length || r.triggerHandler(v)
                    })
                }(e), e.open = !0, e.list.addClass(p), e.toggle.addClass(p), e.toggle.attr("aria-expanded", "true"), m.intro(0, e.el[0]), i.redraw.up(), e.manageZ && e.el.css("z-index", g + 1);
                var r = i.env("editor");
                s || c.on(d + h, e.outside), e.hovering && !r && e.el.on("mouseleave" + h, e.leave), e.hovering && r && c.on("mousemove" + h, e.moveOutside), window.clearTimeout(e.delayId)
            }
        }
        ...
        function E(t) {
            ...
            if (t.open && (!t.config.hover || !t.hovering || i)) {
                ...
                var a = t.config;
                if (m.outro(0, t.el[0]), c.off(d + h, t.outside), t.el.off("mouseleave" + h, t.leave), c.off("mousemove" + h, t.moveOutside), window.clearTimeout(t.delayId), !a.delay || n) return t.complete();
        ...
        return u.ready = b, u.design = function () {
            w && c.find(h).each(function (e, n) {
    ...
    r.define("forms", t.exports = function (t, e) {
        ...
        function y(e, n) {
                ...
                ! function (e, n) {
                    ...
                    if (g) l.on("click", function (t) {
                        ...
                        v.on("click", function () {
                            ...
                            (i = r.target && r.target.files && r.target.files[0]) && (o.toggle(!1), c.toggle(!1), a.toggle(!0), m.text(i.name), T() || k(n), n.fileUploads[e].uploading = !0, function (e, n) {
                                var i = {
                                    name: e.name,
                                    size: e.size
                                };
            ...
            r.handler = null, r.redirect = i.attr("data-redirect"), w.test(s) ? r.handler = E : s || (o ? r.handler = "function" == typeof hostedSubmitWebflow ? hostedSubmitWebflow : A : b())
        }
    ...
    var i = n(0),
        r = n(1);
    i.define("navbar-ufa", t.exports = function (t, e) {
        var n, o, a, s, u = {},
            c = t.tram,
            l = t(window),
            f = t(document),
        ...
        function A(n, r) {
            ...
            u || (u = t.data(r, p, {
            ...
            }(u), u.el.off(p), u.button.off(p), u.menu.off(p), T(u), a ? (O(u), u.el.on("setting" + p, function (t) {
                return function (n, i) {
                    i = i || {};
                    var r = l.width();
                    T(t), !0 === i.open && R(t, !0), !1 === i.open && N(t, !0), t.open && e.defer(function () {
                        r !== l.width() && C(t)
                    })
                }
            }(u))) : (! function (e) {
                if (e.overlay) return;
                e.overlay = t(h).appendTo(e.el), e.parent = e.menu.parent(), N(e, !0)
                ...
                return function (n) {
                    var r = t(this),
                        o = r.attr("href");
                    i.validClick(n.currentTarget) ? o && 0 === o.indexOf("#") && e.open && N(e) : n.preventDefault()
                }
            }(u))), S(n, r)
        }
        ...
        function T(t) {
            ...
            n.animOver = /^over/.test(r), n.animDirect = /left$/.test(r) ? -1 : 1, i.animation !== r && t.open && e.defer(C, t), n.easing = t.el.attr("data-easing") || "ease", n.easing2 = t.el.attr("data-easing2") || "ease";
        ...
        function S(e, n) {
            ...
            if (!i.open || r || a || N(i, !0), i.container.length) {
                var o = function (e) {
        ...
        function R(t, e) {
            if (!t.open) {
                t.open = !0, t.menu.each(M), t.links.addClass(b), t.dropdowns.addClass(m), t.dropdownToggle.addClass(g), t.dropdownList.addClass(w), t.button.addClass(v);
                var n = t.config;
                ...
                var r = j(t),
                    ...
                    u = t.el.height(),
                    l = t.el[0];
                if (S(0, l), y.intro(0, l), i.redraw.up(), a || f.on("click" + p, t.outside), !e) {
        ...
        function N(t, e) {
            ...
            function u() {
                t.menu.height(""), c(t.menu).set({
                    x: 0,
                    y: 0
                }), t.menu.each(D), t.links.removeClass(b), t.dropdowns.removeClass(m), t.dropdownToggle.removeClass(g), t.dropdownList.removeClass(w), t.overlay && t.overlay.children().length && (x.length ? t.menu.insertAfter(x) : t.menu.prependTo(t.parent), t.overlay.attr("style", "").hide()), t.el.triggerHandler("w-close")
            }
        }
        return u
    })
    ...
    i.define("tabs", t.exports = function (t) {
        ...
        function w() {
            n = l && i.env("design"), (e = s.find(h)).length && (e.each(x), i.env("preview") && !g && e.each(y), b(), i.redraw.on(o.redraw))
        }
        ...
        function k(e, n) {
            ...
            if (s !== e.current) {
                e.current = s, e.links.each(function (i, o) {
                    ...
                    if (n.immediate || r.immediate) {
                        var u = e.panes[i];
                        o.id || (o.id = e.tabIdentifier + "-" + i), u.id || (u.id = e.paneIdentifier + "-" + i), o.href = "#" + u.id, o.setAttribute("role", "tab"), o.setAttribute("aria-controls", u.id), o.setAttribute("aria-selected", "false"), u.setAttribute("role", "tabpanel"), u.setAttribute("aria-labelledby", o.id)
                    }
                    o.getAttribute(f) === s ? a.addClass(p).removeAttr("tabindex").attr({
                        "aria-selected": "true"
                ...
                e.panes.each(function (e, n) {
                    var i = t(n);
                    n.getAttribute(f) === s ? u.push(n) : i.hasClass(v) && l.push(n)
                });
                var d = t(u),
                    h = t(l);
                if (n.immediate || r.immediate) return d.addClass(v).each(m.intro), h.removeClass(v), void(g || i.redraw.up());
                h.length && r.outro ? (h.each(m.outro), a(h).add("opacity " + r.outro + "ms " + o, {
                    fallback: c
                }).start({
                    opacity: 0
                }).then(w)) : w()
            ...
            function w() {
                if (h.removeClass(v).css({
                        opacity: "",
                        transition: "",
                        transform: "",
                        width: "",
                        height: ""
                    }), d.addClass(v).each(m.intro), i.redraw.up(), !r.intro) return a(d).set({
                    opacity: 1
                });
                a(d).set({
                    opacity: 0
